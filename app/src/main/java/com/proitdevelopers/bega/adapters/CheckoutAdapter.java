...
import com.proitdevelopers.bega.utilsClasses.CheckOutItemsListView;
...
public class CheckoutAdapter extends RecyclerView.Adapter<CheckoutAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        if (checkoutOrder != null){
            ...
            holder.txt_cart_total.setText(context.getString(R.string.cart_info_bar_total, Float.parseFloat(checkoutOrder.total_cart)) + " AKZ");
