...
public class TesteLoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String TAG = "TesteLoginActivity";
...
//    private Pinview pinCodigoConfirmacaoTelef;
    ...
    private void initViews() {
        ...
        progressDialog = new ProgressDialog(TesteLoginActivity.this);
        ...
        btnRegistro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TesteLoginActivity.this, RegistroActivity.class);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.dialog_btn_telefone_redif_enviar_telefone:
                esconderTeclado(TesteLoginActivity.this);
            ...
            case R.id.receberDeNovoTelefone:
                if (!TextUtils.isEmpty(telefoneReceberDeNovo)) {
                    ...
                    esconderTeclado(TesteLoginActivity.this);
                    mostrarMensagem(TesteLoginActivity.this, R.string.txtTentarmaistarde);
                }
                break;
    ...
    private boolean verificarCampoTelef() {
        ...
        if (codigoConfTelef.isEmpty()) {
            mostrarMensagem(TesteLoginActivity.this, R.string.txtMsgCondConf);
            pinCodigoConfirmacaoTelef.requestFocus();
            pinCodigoConfirmacaoTelef.setError(msgErro);
            return false;
        }
        if (codigoConfTelef.length() <2) {
            mostrarMensagem(TesteLoginActivity.this, R.string.txtMsgCondConfCod);
            return false;
        }
        ...
        enviarCod.enqueue(new Callback<String>() {
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                if (!response.isSuccessful()) {
                    ...
                    mostrarMensagem(TesteLoginActivity.this, "errorResponce.getError()");
...
//                    mostrarDialogoOK(message);
            ...
            public void onFailure(@NonNull Call<String> call, @NonNull Throwable t) {
                progressDialog.dismiss();
                if (!conexaoInternetTrafego(TesteLoginActivity.this,TAG)) {
                    mostrarMensagem(TesteLoginActivity.this, R.string.txtMsg);
                } else if ("timeout".equals(t.getMessage())) {
                    mostrarMensagem(TesteLoginActivity.this, R.string.txtTimeout);
                } else {
                    mostrarMensagem(TesteLoginActivity.this, R.string.txtProblemaMsg);
                }
...
//        ApiInterface apiInterface = ApiClient.apiClient().create(ApiInterface.class);
        ...
        enviarYelefoneReset.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                if (response.isSuccessful()) {
                    progressDialog.dismiss();
                    mostrarMensagem(TesteLoginActivity.this, R.string.txtCodigoenviado);
                } else {
                    ErrorResponce errorResponce = ErrorUtils.parseError(response);
                    Toast.makeText(TesteLoginActivity.this, errorResponce.getError(), Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }
...
//
    ...
    private void launchHomeScreen() {
        Intent intent = new Intent(TesteLoginActivity.this, MenuActivity.class);
